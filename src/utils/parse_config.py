...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, local_rank=-1, run_id=None):
        ...
        and logging module.
        :param config: Dict containing configurations, hyperparameters for training. contents of `checkpoint_config.json` file for example.
    ...
    def from_args(cls, args, options="", local_rank=-1):
        ...
        if hasattr(args,'resume') and args.resume is not None:
            ...
            msg_no_cfg = "Configuration file need to be specified. Add '-c checkpoint_config.json', for example."
    ...
    def get_default_configs(cls):
        config_path = ROOT_PATH / 'src' / 'checkpoint_config.json'
